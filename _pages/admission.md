...
答：高中阶段在全国青少年信息学奥林匹克竞赛（NOI）或中国数学奥林匹克竞赛（CMO）中获得决赛三等奖（铜牌）及以上的新生，可免试直接入选计算机拔尖班，不限制专业（强基计划、外语保送生、艺术类考生等国家有相关规定或者录取前与学校有明确约定的学生除外）。高中阶段在全国青少年信息学奥林匹克联赛（NOIP）中获得省级赛区一等奖免笔试进入复试（面试）。对于免笔试录取考生，复试成绩需达75分（含）以上，按复试成绩排序择优录取，免笔试（含免试）录取人数不超过10人，同分顺延。

### 6. 我决定参加选拔考试，我要准备什么？

答：初试以笔试形式考察学生的数学和物理基础，其中数学和物理各占一半分值，难度与高中竞赛的难度相当。复试以面试形式考核英语能力、基础能力、综合素质。其中英语考察学生的英语听说读写能力。
